...
- **Prefer the employer's own careers posting over an aggregator listing** (LinkedIn, jobup.ch, jobscout24.ch). Aggregators routinely drop the requisition ID and the grade or seniority level, and the grade is often the single most decision-relevant fact in the posting. Surface any material discrepancy between the two versions to the user.
